import {  TECHapp, lacostillita, thewinenation, Lumiflowca, Sagcomstore, BlueWaveEnergy, CrealabStudio, ViaViajes, SolarComfortUSA, PreferredEnergyPower, TaskFlowAI, Allsafebackflow  } from "@static/images";
  ...
  `,
      ...
      },
    {
        ...
        extraInfo: [
            {
                "title": "Tecnologías y Herramientas",
                "description": "WordPress, Elementor, PHP, Contact Form 7, Yoast SEO, HTML-CSS"
            },
            {
                "title": "Fecha",
                "description": "2024-01-01"
        ...
        content: `
                <section id="proyecto-lacostillita" class="proyecto">
                    <h3>🥩 Proyecto: La Costillita – Sitio Web Gastronómico</h3>
                    <p><strong>Cliente:</strong> Parrilla tradicional argentina con enfoque en carnes premium y experiencia regional</p>
                    <p><strong>Rol:</strong> Desarrollador Full Stack & Diseñador técnico</p>
                    <p><strong>Fecha:</strong> 1 de enero de 2024</p>
                    <p><strong>URL:</strong> 
                        <a href="https://lacostillita.com.ar" target="_blank" rel="noopener noreferrer">lacostillita.com.ar</a>
                    </p>
                    <hr>
                    <h4>🎯 Objetivo del proyecto</h4>
                    <p>Diseñar una página web institucional que refleje la identidad gastronómica de La Costillita, facilitando la reserva de mesas, la consulta del menú y el contacto directo con clientes, todo con una estética cálida y profesional.</p>
                    <h4>🛠️ Tecnologías y herramientas</h4>
                    <ul>
                        <li><strong>CMS:</strong> WordPress</li>
                        <li><strong>Constructor visual:</strong> Elementor</li>
                        <li><strong>Backend:</strong> PHP personalizado para funcionalidades específicas</li>
                        <li><strong>Plugins:</strong>
                        <ul>
                            <li><em>Contact Form 7</em> para formularios de reserva y contacto</li>
                            <li><em>Yoast SEO</em> para optimización en buscadores</li>
                        </ul>
                        </li>
                    </ul>
                    <h4>📱 Características destacadas</h4>
                    <ul>
                        <li><strong>Diseño responsive:</strong> navegación fluida en móviles, tablets y escritorio</li>
                        <li><strong>Estética gastronómica:</strong> paleta cálida, tipografía tradicional y estructura visual apetitosa</li>
                        <li><strong>Formularios funcionales:</strong> reservas y consultas automatizadas</li>
                        <li><strong>Optimización SEO:</strong> estructura semántica, metadatos y velocidad de carga</li>
                        <li><strong>Personalización con PHP:</strong> adaptaciones específicas para mejorar la experiencia del cliente</li>
                    </ul>
                    <h4>📊 Resultados e impacto</h4>
                    <ul>
                        <li>Incremento en reservas online desde el primer mes</li>
                        <li>Mayor visibilidad en buscadores locales</li>
                        <li>Reducción de consultas telefónicas gracias a formularios automatizados</li>
                    </ul>
                    <h4>🧠 Valor agregado</h4>
                    <p>Este proyecto refleja mi capacidad para combinar <strong>identidad de marca, diseño emocional y soluciones técnicas personalizadas</strong>, creando una experiencia digital que acompaña la propuesta gastronómica de forma auténtica y funcional.</p>
                </section>
        `,
    },
    {
